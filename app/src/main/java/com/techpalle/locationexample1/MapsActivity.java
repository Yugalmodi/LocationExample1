package com.techpalle.locationexample1;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    LocationListener locationListener;//SELECT android.location
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mMap.addMarker(new MarkerOptions().position(sydney).title("palle"));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Toast.makeText(MapsActivity.this, "Sydney", Toast.LENGTH_SHORT).show();
    }
}
